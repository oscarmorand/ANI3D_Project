...
#include "simulation/grid_container.hpp"
...
struct scene_structure : cgp::scene_inputs_generic {
	...
	cgp::numarray<std::shared_ptr<particle_element>> particles;      // Storage of the particles
	grid_container particles_grid; // grid used to store the particles
