...
void scene_structure::new_fluid_gui()
{
	...
	if (gui.new_fluid_creation)
	{
		...
		*/
		...
		bool create_pressed = ImGui::Button("Create fluid");
		ImGui::SameLine();
...
void scene_structure::select_color_mode()
{
...
void scene_structure::display_gui()
{
	...
	ImGui::SameLine();
	ImGui::RadioButton("Remove particles", &gui.right_click_action, REMOVE_PARTICLES);
	ImGui::SameLine();
	ImGui::RadioButton("Add repulsive force", &gui.right_click_action, ADD_RADIAL_FORCE);
	ImGui::RadioButton("Add vortex", &gui.right_click_action, ADD_VORTEX_FORCE);
	ImGui::SameLine();
	...
	else if (gui.right_click_action == ADD_RADIAL_FORCE || gui.right_click_action == ADD_VORTEX_FORCE || gui.right_click_action == ADD_GRAVITY_FORCE)
	{
		...
		{
			ImGui::RadioButton("Clockwise", &gui.vortex_direction, CLOCKWISE);
			ImGui::SameLine();
